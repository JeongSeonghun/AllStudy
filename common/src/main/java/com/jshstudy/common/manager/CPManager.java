...
public class CPManager extends ContentProvider{
    ...
    static final Uri CONTENT_URI = Uri.parse("content://jsh.example.allstudy/cp");
    ...
    static {
        ...
        uriMatcher.addURI("jsh.example.allstudy", "cp", 1);
        uriMatcher.addURI("jsh.example.allstudy", "cp/*", 2);
    }
